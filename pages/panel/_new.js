...
const New = (props) => {
  ...
  const grabSavedPostData = (value) => {
      ...
      console.log('there is grabed post data sended with axios in child componet and here');
  ...
  function getStepContent(step) {
    ...
    switch (step) {
      ...
      case 1:
        return <MainForm edit_id= {edit_id} cat={cat} grabSavedPostData = {(value) => {
                  console.log("the posted data with status 3 in parent section   -->",value);
                  grabSavedPostData(value);
              }}/>;
      case 2:
        return <LocationForm returnedWorker={returnedWorker} />;
      default:
  ...
  if(loading){
    ...
    return (
      <ThemeProvider theme={mdTheme}>
        ...
        <Paper variant="outlined" sx={{ my: { xs: 5, md: 6 }, p: { xs: 3, md: 3 } }}>
