  ...
  return (
    <div className="realstate-contents-wrapper">
      <Head>
        ...
        ></meta>
        <title>
          مشاور املاک هوشمند آجر | {realstate.name} {realstate.family}
        </title>
        <meta name="description" content={realstate.description} />
        <meta
          name="robots"
        ...
        />
        <meta property="og:image" content={realstate.profile_url} />
        ...
        <meta
          name="twitter:data1"
          content={realstate.name + realstate.family}
        />
